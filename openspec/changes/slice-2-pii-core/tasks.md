...
- [ ] 7.2 Docs parity: the relay-configuration spec check (keyring/epoch/rules URL), README PII note; `just ci`
      green + coverage ≥85%; pre-commit all-files; mark OpenSpec task lists T2 complete
- [ ] 7.3 Run end-of-file-fixer before archive; `openspec archive slice-2-pii-core`; final commit
