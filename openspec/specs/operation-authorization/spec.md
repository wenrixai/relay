...
unverifiable operation. Oversize inspectable bodies SHALL return 413 and un-parseable XML SHALL
return 502 `xml_parse_error`, consistent with the other body-inspection stages.
